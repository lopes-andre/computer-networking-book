...
while True:
	...
	try:
		...
		filename = message.split()[1] # Gets the second part of the HTTP header
		...
		connectionSocket.send("<html><head><title>404 Not Found</title></head><body><center><h1>404 Page Not Found</h1></center></body></html>\r\n")
